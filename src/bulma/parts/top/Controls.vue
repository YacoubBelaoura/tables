<template>
    <core-controls>
        <template v-slot:default="{
            ...
            <div class="top-controls bg-white-smoke">
                ...
                <div class="flex flex-wrap -m-3">
                    ...
                    <div class="table-controls
                     block w-full sm:w-1/2 lg:w-1/3 text-center sm:ltr:text-left sm:rtl:text-right p-1">
                        ...
                        <!-- <a class="button" -->
                        <a class="button h-9 hover:border-blue-300"
                            v-on="reloadEvents"
                    ...
                    block w-full sm:w-1/2 lg:w-1/3 text-center sm:rtl:text-left sm:ltr:text-right p-1"
                        ...
                        <a v-for="button in state.template.buttons.global"
                            class="bg-white button h-9 ltr:ml-1 rtl:mr-1 px-3"
                            :class="button.class"
                            :key="button.label"
                    ...
                    <div class="block lg:w-1/3 p-1 search-input w-full">
